...
- `.ai/tasks/backlog/extension-webmcp-agent.md` — 扩展 Side Panel WebMCP Agent（页面 Tab 控制，互补，非 Gist CRUD）
- `.ai/tasks/backlog/editor-webmcp.md` — 编辑器 `editor_*` WebMCP（独立 backlog）
