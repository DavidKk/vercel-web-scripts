...
- **Preset GME WebMCP** (`GME_registerWebMcpTool` — script registers page tools — **P0 implemented**)
  ...
  - Author: `public/docs/gme-webmcp-skill.md` (MCP: `skill://magickmonkey/gme-webmcp-skill.md`)
  - Code: `shared/webmcp/`, `preset/src/helpers/webmcp.ts`
  - Related: `tasks/backlog/extension-webmcp-agent.md` (downstream consumer — backlog)
