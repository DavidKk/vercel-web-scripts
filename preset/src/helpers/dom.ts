...
/**
 * Append container to document.body when body is available.
 * Used when script runs at document-start and body may not exist yet.
 * @param container Element to append
 */
export function appendWhenBodyReady(container: HTMLElement): void {
